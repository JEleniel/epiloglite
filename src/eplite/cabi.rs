...
#![cfg_attr(feature = "cabi", allow(clippy::missing_safety_doc))]
#![cfg_attr(feature = "cabi", allow(clippy::not_unsafe_ptr_arg_deref))]
#![cfg_attr(feature = "cabi", allow(non_snake_case))]
#![cfg_attr(feature = "cabi", allow(unsafe_code))]
