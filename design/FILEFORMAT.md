...
|   32   |  u32   | Page number of the first [freelist page](#free-page-list)                                       |
...
_Table B-Tree Interior Cell (header 0x05):_
